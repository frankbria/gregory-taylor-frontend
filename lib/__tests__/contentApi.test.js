...
describe('useContentAPI Hook', () => {
  ...
  describe('getAllPages', () => {
    ...
    it('should fetch all pages successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/admin/pages', { credentials: 'include' })
    ...
    it('should use relative URL even when API base URL is not defined', async () => {
  ...
  describe('getPageContent', () => {
    ...
    it('should fetch page content by id', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/admin/pages/page1', { credentials: 'include' })
  ...
  describe('updatePageContent', () => {
    ...
    it('should update page content successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/admin/pages/page1', {
        method: 'PUT',
    ...
    it('should use relative URL even when API base URL is not defined', async () => {
      ...
      let updated
      await act(async () => {
        updated = await result.current.updatePageContent('page1', { hero: 'test' })
      })

      expect(fetch).toHaveBeenCalledWith('/api/admin/pages/page1', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ hero: 'test' }),
        credentials: 'include'
      })
      expect(updated).toEqual(mockUpdatedPage)
  ...
  describe('getImageSettings', () => {
    ...
    it('should fetch image settings successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/admin/settings/images', { credentials: 'include' })
  ...
  describe('updateImageSettings', () => {
    ...
    it('should update image settings successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/admin/settings/images', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
    ...
    it('should use relative URL even when API base URL is not defined', async () => {
      ...
      let settings
      await act(async () => {
        settings = await result.current.updateImageSettings({ maxWidth: 2048 })
      })

      expect(fetch).toHaveBeenCalledWith('/api/admin/settings/images', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ maxWidth: 2048 }),
        credentials: 'include'
      })
      expect(settings).toEqual(mockUpdatedSettings)
  ...
  describe('getLayoutSettings', () => {
    ...
    it('should fetch layout settings successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/admin/settings/layout', { credentials: 'include' })
  ...
  describe('updateLayoutSettings', () => {
    ...
    it('should update layout settings successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/admin/settings/layout', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
    ...
    it('should use relative URL even when API base URL is not defined', async () => {
      ...
      let settings
      await act(async () => {
        settings = await result.current.updateLayoutSettings({ columns: 4 })
      })
...
describe('Standalone contentApi exports', () => {
  ...
  describe('getAllPages (standalone)', () => {
    ...
    it('should use relative URL even when base URL missing', async () => {
      const { getAllPages } = await import('../contentApi')
  ...
  describe('getPageContent (standalone)', () => {
    it('should fetch page content by id', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/admin/pages/1', { credentials: 'include' })
      expect(result).toEqual({ _id: '1', title: 'Home' })
    })
  ...
  describe('updatePageContent (standalone)', () => {
    it('should update page content', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith('/api/admin/pages/1', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
